...
class IDPartner {
  ...
  async #getTokenSet(codeResponse, expectedIssuer, { state, nonce, codeVerifier }) {
  ...
  async claims(codeResponse, expectedIssuer, proofs) {
    const tokenSet = await this.#getTokenSet(codeResponse, expectedIssuer, proofs);
    return tokenSet.claims();
  }

  token(codeResponse, expectedIssuer, proofs) {
    return this.#getTokenSet(codeResponse, expectedIssuer, proofs);
  }

  async credential(expectedIssuer, tokenSet, body) {
