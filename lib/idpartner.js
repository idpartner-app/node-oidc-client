...
class IDPartner {
  ...
  async paymentDetailsInfo(expectedIssuer, accessToken, options={}) {
    ...
    const httpClient = createHttpClient(client.issuer.payment_details_info_endpoint);
    ...
    return data;
    // return client.requestResource(client.metadata.payment_details_endpoint, accessToken, options);
    // return client.requestResource(new url.URL(client.issuer.payment_details_info_endpoint), accessToken, options);
  }
